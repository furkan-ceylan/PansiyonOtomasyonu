...
namespace OtelOtomasyonu
{
    class MusteriKayit
    {
        ...
        public void kayitAl(string ad, string soyad,string cinsiyet,string tc,string oda,string kullaniciAdi,string sifre,string girisTarihi,string cikisTarihi)
        {
            if (database.baglanti.State == System.Data.ConnectionState.Open)
            {
                database.baglanti.Close(); // bağlantı açıksa bağlantıyı kapat
            ...
            try
            {
                ...
                OracleCommand kayitEkle = new OracleCommand("INSERT INTO MUSTERI (MusteriAd,MusteriSoyad,MusteriCinsiyet,MusteriKad,MusteriSifre,MusteriTC,MusteriOda,girisTarihi,cikisTarihi) VALUES(:MusteriAd,:MusteriSoyad,:MusteriCinsiyet,:MusteriKad,:MusteriSifre,:MusteriTC,:MusteriOda,:girisTarihi,:cikisTarihi)",
                ...
                kayitEkle.Parameters.Add(new OracleParameter(":MusteriKad", kullaniciAdi));
                kayitEkle.Parameters.Add(new OracleParameter(":MusteriSifre", sifre));
