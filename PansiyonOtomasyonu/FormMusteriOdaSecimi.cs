...
{
    public partial class FormMusteriOdaSecimi : Form
    {
        Button seciliButon;

        public FormMusteriOdaSecimi()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MusteriKayitOdaSecimi kayit = new MusteriKayitOdaSecimi();
            ...
            for(int i = 0; i < odalar.Count; i++)
            {
                ...
                kayit.kayitAl(txtAd.Text, txtSoyad.Text, cbCinsiyet.Text, txtTc.Text,room,girisTarihi.ToString("dd/MM/yyyy"),cikisTarihi.ToString("dd/MM/yyyy"));
        ...
        private void FormMusteriOdaSecimi_Load(object sender, EventArgs e)
        {
            timer1.Start();
        }
